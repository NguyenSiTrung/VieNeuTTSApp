...
- Real-model timing budget (offscreen CPU int8): ~45-char sentence ≈ 3–8 s wall clock; model load ≈ 30 s on first request — size e2e timeouts accordingly. The seeded HF cache needs no network despite HF_TOKEN warning noise (from: phase03_corefeat_20260827, 2026-08-27).

---

Last refreshed: 2026-08-27 (/conductor-refresh — consolidated learnings from archived tracks phase01_core, phase02_uishell, phase03_corefeat)
