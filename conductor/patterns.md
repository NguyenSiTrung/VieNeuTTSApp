...
- Parallel sub-agents sharing a git index hit `index.lock` occasionally: serialize commits through the orchestrator (retry-after-5s also works); agents run only their scoped tests — the orchestrator runs the full gate before committing (from: phase02_uishell_20260827 + phase03_corefeat_20260827, 2026-08-27).
...
Last refreshed: 2026-08-27 (phase04_streaming_20260827 close-out — elevated streaming/QML/driver/probing/units patterns; re-measured real-model timing; u5c disposition recorded)
