...
Tasks 5.1, 5.2 and 5.3 complete, Phase 0 partial (Task 0.3 needs release hardware). All commits are
...
## Next: the Phase 4/Phase 5 manual checkpoints, then Phase 5 Task 5.4
...
- `bd` epic `VieNeuTTSApp-nqx`; Phase 3 tasks are `.5.x` (all closed, including the manual
  ...
  manual checkpoint), Phase 5 tasks are `.7.x` (`.7.1`, `.7.2` and `.7.3` closed; `.7.5` is the Phase 5
